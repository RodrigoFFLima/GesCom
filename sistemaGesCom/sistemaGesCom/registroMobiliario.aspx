<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registroMobiliario.aspx.cs" Inherits="sistemaGesCom.registroMobiliario" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://bootstrapformhelpers.com/assets/css/bootstrap-formhelpers.min.css"/>
...
<body>
      ...
      *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i> Cadastro de Mobilias</h3>

                <!-- BASIC FORM ELELEMNTS -->
                <div class="row mt">
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <h4 class="mb"><i class="fa fa-angle-right"></i> Mobilia</h4>
                            ...
                            <form class="form-horizontal style-form" method="get" runat="server">
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Descriçao do Movel</label>
                                    <div class="col-sm-10">
    ...
    <script src="http://bootstrapformhelpers.com/assets/js/bootstrap-formhelpers.min.js" type="text/javascript"></script>
    
    <script>
        //custom select box
        $(function () {
            $("#txtValorCompra").maskMoney({ prefix: 'R$ ', allowNegative: true, thousands: '.', decimal: ',', affixesStay: false });
        });
    </script>
